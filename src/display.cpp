...
void setModusScreen()
{
   ...
   /*
    ...
    u8g2.drawStr(char_x+2,char_y + charh+54 ,"DIST");
    */
   char_y = 3;
...
void updateModusScreen(uint8_t modus)
{
   switch (curr_modus)
   {
      ...
      {
         u8g2.setDrawColor(0);
         u8g2.drawBox(char_x - 4,char_y ,100,80);
         u8g2.setDrawColor(1);
         char_y = 3;
      }break;
      case DIST:
      {
         u8g2.setDrawColor(0);
         u8g2.drawBox(char_x - 4,char_y + 2,100,80);
         u8g2.setDrawColor(1);
   ...
   Serial.print("updateModusScreen char_y: ");
   ...
   switch (curr_modus)
   {
      ...
      case DIST:
      {
         Serial.print("case DIST char_y: ");
         Serial.println(char_y);
         u8g2.setDrawColor(1);
         u8g2.drawFrame(char_x-2,char_y + 54 ,56,18);
         if (diststatus & (1<<DIST))
         {
            u8g2.drawStr(char_x+55,char_y + charh+54 ,"ON ");
         }
         else
         {
            u8g2.drawStr(char_x+55,char_y + charh+54 ,"OFF");
         }
         //u8g2.sendBuffer();
